...
namespace RevitEasy
{
    ...
    public class Ribbon : IExternalApplication
    {
        ...
        public Result OnStartup(UIControlledApplication application)
        {
            ...
            PushButtonData OpenDetailRoomsFormButtonData = new PushButtonData("DetailRoomsFormButton", "Detail Rooms", typeof(OpenDetailRoomsFormCommand).Assembly.Location, "RevitEasy.OpenDetailRoomsFormCommand")
            {
                LargeImage = ConvertImage(Properties.Resources.IconDetailRoom32x32),
                ToolTip = "Detail Rooms",
            ...
            // Pushbutton "Open Export Schedules Form" in the label "Documentation"
            PushButtonData openExportSchedulesFormButtonData = new PushButtonData("ExportSchedulesFormButton","Export Schedules to excel",typeof(OpenExportSchedulesFormCommand).Assembly.Location,"RevitEasy.OpenExportSchedulesFormCommand")
            {
                LargeImage = ConvertImage(Properties.Resources.IconoDePushButton03),
                ToolTip = "Export Schedules Form",
                LongDescription = "Export Schedules to excel",
                ToolTipImage = ConvertImage(Properties.Resources.IconoDePushButton03)
            };

            ContextualHelp contextualHelpExportSchedules = new ContextualHelp(ContextualHelpType.Url,"https://github.com/CRUZHENRIQUEDEV/RevitEasy");
            openExportSchedulesFormButtonData.SetContextualHelp(contextualHelpExportSchedules);
            DocumentacaoButton.AddPushButton(openExportSchedulesFormButtonData);
